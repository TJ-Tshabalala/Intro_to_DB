...
CREATE TABLE `Order_Details` (
    ...
    KEY book_id (book_id),
    CONSTRAINT FK_OrderDetailOrder FOREIGN KEY (order_id) REFERENCES Orders(order_id),  -- No backticks here
    CONSTRAINT FK_OrderDetailBook FOREIGN KEY (book_id) REFERENCES Books(book_id)   -- No backticks here
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
